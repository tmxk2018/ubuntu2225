...
if __name__ == "__main__":
    line_x = ReadFile('Aubo_vision_move_x.txt')
    line_y = ReadFile('Aubo_vision_move_y.txt')
    line_z = ReadFile('Aubo_vision_move_z.txt')
    ...
    ax3.grid()
    plt.tight_layout()
    plt.savefig('Accuracy of AuboVision Pluging with AGV motion.png')
    plt.show()
