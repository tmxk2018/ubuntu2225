...
def test_process_demo():
    ...
    try:
        ...
        if result != RobotErrorType.RobotError_SUCC:
            ...
            joint_maxacc = (2.5, 2.5, 2.5,2.5, 2.5, 2.5)
            ...
            while True:
                ...
                # joint_radian = (0, 0, 0, 0, 0, 0)
                # joint_current=robot.get_current_waypoint()
                # print("current point :",joint_current)
                # print("-------------okok")
                # break
                ...
                # home
                joint_radian=(0,-0.127267, -1.321122, 0.376934, -1.570796, -0.000008)
                robot.move_joint(joint_radian,True)
                time.sleep(2)
                # down
                joint_radian=(0,-0.191917, -1.806449, -0.043735, -1.570796, -0.000008)
                robot.move_joint(joint_radian,True)
                time.sleep(2)
                #left
                joint_radian=(0.380503, 0.004944, -1.629526, -0.063673, -1.570796, 0.380498)
                robot.move_joint(joint_radian,True)               
                time.sleep(2)
                #right
                joint_radian=(-0.378896, -0.039111, -1.737082, -0.127175, -1.570796, -0.378901)
                robot.move_joint(joint_radian,True)
                time.sleep(2)
                #head
                joint_radian=(-0.000002, 0.053640, -1.643594, -0.126438, -1.570796, -0.000007)
                robot.move_joint(joint_radian,True)
                time.sleep(1)
