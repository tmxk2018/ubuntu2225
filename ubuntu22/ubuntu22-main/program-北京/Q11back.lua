--- Auto generated by 'aubo_scope' v0.31.0-alpha.58 2025-02-25 13:21:05
--- DO NOT MODIFY IT!
local app = {}
...
function p_Q11back()
    ...
    setLabel(42, "等待：1.00s")
    sleep(1)
    
    setLabel(43, "ARCS_3DPZ222.lua")
    --subscript context start
     ip = "192.168.192.111" --服务端IP地址
        port = 55000 --串口号
    ...
    setLabel(46, "等待：1.00s")
    sleep(1)
    
    setLabel(47, "设置 finish=1")
    modbusSetOutputSignal('finish', 1)
    
    setLabel(48, "等待：1.00s")
    sleep(1)
    
    sched.sync_program_point()
    if (currentPointA == 1.02256) then
        setLabel(49, "如果 currentPointA == 1.02256")
        setLabel(50, "关节运动")
        setLabel(51, "UUUPPP")
        ...
        setLabel(66, "等待：1.00s")
        sleep(1)
        
        setLabel(67, "设置 control=1035")
        modbusSetOutputSignal('control', 1035)
        
        setLabel(68, "等待：1.50s")
        sleep(1.5)
        ...
        setLabel(74, "等待：1.00s")
        sleep(1)
        
        setLabel(75, "homeB")
        moveJoint(inverseKinematics(homeB_q, homeB_p), 0.872665, 0.698132, 0, 0)
        
        setLabel(76, "等待：1.00s")
        sleep(1)
        ...
        setLabel(79, "设置 control=811")
        modbusSetOutputSignal('control', 811)
        
        setLabel(80, "等待：1.50s")
        sleep(1.5)
