...
<AuboProgram name="A8143" installation="jodel11" installationRelativePath="jodel11.ins" directory="/root/arcs_ws/program" createdIn="0.31.0-alpha.58" lastSaveIn="0.31.0-alpha.58" robotSerialNumber="A1105312DA80264" crcValue="225635">
    ...
    <WaypointModel>
        ...
        <Waypoint name="路点_0">
            <RobotPose pose="-0.3899372903228141,0.04229275100658898,0.2946139088433692,3.141290594768136,0.0004527424804051677,-1.139732032581246"/>
            <JointPositions angles="-0.4229735906636156,-0.2003665468932473,-2.133504779376866,-0.3628816817815849,-1.57086601932761,-0.8540379720638803"/>
            <TcpOffset pose="0,0,0,0,0,0"/>
            <Kinematics status="NOT_INITIALIZED" validChecksum="false">
                <theta value="0,0,0,0,0,0"/>
                <a value="0,0,0,0,0,0"/>
    ...
    <MainProgramNode title="机器人编程" id="b5571394-7241-4c34-a4ed-cf2c67d272e3">
        ...
        <children>
            ...
            <MoveNode title="关节运动" id="b58c4807-cf8c-4127-95f4-6ee9dfee04a1">
                <datamodel>
                ...
                <children>
                    <WaypointNode title="路点_0" id="12e98a2d-4fb0-4b38-80c2-95b76e9d5d24">
                        <datamodel>
                    ...
                    <ScriptNode title="Ca.lua" id="956dbdc9-9538-4d35-8298-6f894d782152">
                        <datamodel>
                            <Expression key="expression"/>
                            <String key="file_path" value="Ca.lua"/>
                            <Bool key="use_file" value="true"/>
                        </datamodel>
                    </ScriptNode>
                </children>
            </MoveNode>
            <IfNode title="如果 gdddd_0 == 0.2115554" id="f58f8ff4-c299-4215-9800-d7f5646e3d30">
                <datamodel>
