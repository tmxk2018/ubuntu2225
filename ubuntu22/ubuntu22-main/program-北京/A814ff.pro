...
<AuboProgram name="A814ff" installation="jodel11" installationRelativePath="jodel11.ins" directory="/root/arcs_ws/program" createdIn="0.31.0-alpha.58" lastSaveIn="0.31.0-alpha.58" robotSerialNumber="A1105312DA80264" crcValue="225635">
    ...
    <WaypointModel>
        ...
        <Waypoint name="agvUp">
            <RobotPose pose="-0.5448911985726375,-0.005807264328444869,0.2847448931796543,3.141165124496163,-0.000592545481010776,-2.690608590254557"/>
            <JointPositions angles="-0.214205622593218,0.1998001245471202,-1.761751077515199,-0.3914849644182994,-1.570766982570596,0.9056067782436147"/>
            <TcpOffset pose="0,0,0,0,0,0"/>
            <Kinematics status="NOT_INITIALIZED" validChecksum="false">
                <theta value="0,0,0,0,0,0"/>
                <a value="0,0,0,0,0,0"/>
        ...
        <Waypoint name="agvPut">
            <RobotPose pose="-0.5449954327017199,-0.005775912126039916,0.2102653616721884,3.141370243691653,-0.0003251294323209318,-2.69063499922543"/>
            <JointPositions angles="-0.2142209313052755,0.28865188932879,-1.871196121756604,-0.5894447695761402,-1.570770650598634,0.9056177823277274"/>
            <TcpOffset pose="0,0,0,0,0,0"/>
            <Kinematics status="NOT_INITIALIZED" validChecksum="false">
                <theta value="0,0,0,0,0,0"/>
                <a value="0,0,0,0,0,0"/>
        ...
        <Waypoint name="up2">
            <RobotPose pose="-0.546893831660902,-0.001829751763671703,0.2710045745414698,3.140570202078496,-0.001380174231246704,-2.690518423290579"/>
            <JointPositions angles="-0.2206965165055936,0.2179868744714179,-1.779221379715206,-0.4281285645132952,-1.570737638346296,0.8990263359442732"/>
            <TcpOffset pose="0,0,0,0,0,0"/>
            <Kinematics status="NOT_INITIALIZED" validChecksum="false">
                <theta value="0,0,0,0,0,0"/>
                <a value="0,0,0,0,0,0"/>
        ...
        <Waypoint name="get2">
            <RobotPose pose="-0.5469943555446409,-0.001797158034674469,0.2102438593579288,3.141433037892947,-0.0002950392204764688,-2.690541184489188"/>
            <JointPositions angles="-0.2207148869600626,0.2929965018107056,-1.865274711932767,-0.5878051610433611,-1.570737638346296,0.8990300039723107"/>
            <TcpOffset pose="0,0,0,0,0,0"/>
            <Kinematics status="NOT_INITIALIZED" validChecksum="false">
                <theta value="0,0,0,0,0,0"/>
                <a value="0,0,0,0,0,0"/>
        ...
        <Waypoint name="temp">
            <RobotPose pose="-0.07661309218631321,0.4331871124796806,0.5115080722946984,2.87311040218455,0.1901991876046273,-2.779107330079547"/>
            <JointPositions angles="-1.665244956704785,-0.1882420469437156,-1.638978268556544,-0.2044265385880188,-1.617358274703393,-0.4903163118616995"/>
            <TcpOffset pose="0,0,0,0,0,0"/>
            <Kinematics status="NOT_INITIALIZED" validChecksum="false">
                <theta value="0,0,0,0,0,0"/>
                <a value="0,0,0,0,0,0"/>
        ...
        <Waypoint name="put2">
            <RobotPose pose="-0.1026137057964933,0.5179179457662406,0.2307078363129847,1.606152207392292,0.3826612152212194,3.097676423304653"/>
            <JointPositions angles="-1.602816028934342,0.6024253751439207,-2.022020614689404,-2.591637873865777,-1.595885638571651,-0.3820544643337914"/>
            <TcpOffset pose="0,0,0,0,0,0"/>
            <Kinematics status="NOT_INITIALIZED" validChecksum="false">
                <theta value="0,0,0,0,0,0"/>
                <a value="0,0,0,0,0,0"/>
        ...
        <Waypoint name="put2up">
            <RobotPose pose="-0.1026253845868344,0.5177177264611974,0.2951933977425011,1.603861059990812,0.3826280260046079,3.096821981162186"/>
            <JointPositions angles="-1.602803781964696,0.4583765181677661,-2.002756131436259,-2.430450049784247,-1.595896642655763,-0.3820434602496788"/>
            <TcpOffset pose="0,0,0,0,0,0"/>
            <Kinematics status="NOT_INITIALIZED" validChecksum="false">
                <theta value="0,0,0,0,0,0"/>
                <a value="0,0,0,0,0,0"/>
    ...
    <MainProgramNode title="机器人编程" id="b5571394-7241-4c34-a4ed-cf2c67d272e3">
        ...
        <children>
            <MoveNode title="关节运动" id="ff75ced5-4bf3-47d5-b18e-81b9532a1204">
                ...
                <children>
                    <SetNode title="设置 agvGo=1" id="9b59537a-e556-4c7c-850a-e46865e94e93">
                        <datamodel>
                    ...
                    <WaitNode title="等待：2.00s" id="3288df2f-321a-4f31-bd68-79312bd6f198">
                        <datamodel>
                    ...
                    <WaitNode title="等待：agvOver == 4" id="3288df2f-321a-4f31-bd68-79312bd6f198">
                        <datamodel>
                            <String key="compareOperator" value="LESS_THAN"/>
                            <Bool key="di_value" value="false"/>
                            <Expression key="expression">
                    ...
                    <WaitNode title="等待：1.00s" id="336b40a6-0a1c-4b38-bee9-4155828c3bee">
                        <datamodel>
                            <String key="compareOperator" value="LESS_THAN"/>
                            <Bool key="di_value" value="false"/>
                            <Expression key="expression"/>
            ...
            <ScriptNode title="funcA.lua" id="64dcab67-0da9-4775-bf0a-a3b14f80f7e8">
                <datamodel>
                    <Expression key="expression"/>
            ...
            <ScriptNode title="fget1.lua" id="08ef89eb-ea29-464a-8a82-25968de1fd4e">
                <datamodel>
                    <Expression key="expression"/>
            ...
            <MoveNode title="直线运动" id="88119eee-0a98-49b4-a736-df706dfbc233">
                ...
                <children>
                    ...
                    <SetNode title="设置 control=299" id="3e2a488e-16da-46c6-a826-0caf20e47154">
                        <datamodel>
                            <Float64 key="aoValue" value="4"/>
                            <Bool key="boolValue" value="false"/>
                            <Int32 key="collisionLevel" value="-1"/>
            ...
            <IfNode title="如果 agvPut == 123.0226" id="070b2b2f-9daf-4bea-b2fd-0ed219d51e5f">
                ...
                <children>
                    <MoveNode title="关节运动" id="7920f424-6ee3-4872-8ecf-b28eff4c7759">
                        ...
                        <children>
                            <WaypointNode title="up2" id="173a0d2a-1a05-48fe-a52a-bea2beb4d2a9">
                                <datamodel>
                                    <VectorDouble key="baseToFeature" value="0,0,0,0,0,0"/>
                                    <Float64 key="blendRadius" value="0.02"/>
                                    <String key="blendType" value="NO_BLEND"/>
                                    ...
                                    <String key="type" value="POSITION"/>
                                    <String key="variableType" value="VARIABLE_POSE"/>
                                    <Waypoint key="waypoint" name="up2"/>
                                </datamodel>
                            </WaypointNode>
                            <WaypointNode title="get2" id="20592e2d-340e-4795-afb6-39441f7a5692">
                                <datamodel>
                                    <VectorDouble key="baseToFeature" value="0,0,0,0,0,0"/>
                                    <Float64 key="blendRadius" value="0.02"/>
                                    <String key="blendType" value="NO_BLEND"/>
                                    ...
                                    <String key="type" value="POSITION"/>
                                    <String key="variableType" value="VARIABLE_POSE"/>
                                    <Waypoint key="waypoint" name="get2"/>
                                </datamodel>
                            </WaypointNode>
                            <WaypointNode title="up2" id="173a0d2a-1a05-48fe-a52a-bea2beb4d2a9">
                                <datamodel>
                    ...
                    <MoveNode title="关节运动" id="839c78ae-9b26-47cd-9849-6649b6edfd0e">
                        ...
                        <children>
                            <WaypointNode title="temp" id="5ee1f394-00b2-4ac4-90d6-6ca14e247890">
                                <datamodel>
                                    <VectorDouble key="baseToFeature" value="0,0,0,0,0,0"/>
                                    <Float64 key="blendRadius" value="0.02"/>
                                    <String key="blendType" value="NO_BLEND"/>
                                    ...
                                    <String key="type" value="POSITION"/>
                                    <String key="variableType" value="VARIABLE_POSE"/>
                                    <Waypoint key="waypoint" name="temp"/>
                                </datamodel>
                            </WaypointNode>
                            <WaypointNode title="put2up" id="3982464e-8d03-40f1-a563-227942fa15c5">
                                <datamodel>
                                    <VectorDouble key="baseToFeature" value="0,0,0,0,0,0"/>
                                    <Float64 key="blendRadius" value="0.02"/>
                                    <String key="blendType" value="NO_BLEND"/>
                                    ...
                                    <String key="type" value="POSITION"/>
                                    <String key="variableType" value="VARIABLE_POSE"/>
                                    <Waypoint key="waypoint" name="put2up"/>
                                </datamodel>
                            </WaypointNode>
                            <WaypointNode title="put2" id="d7ab3de4-03d0-40c9-89dd-e7e9b0e2b2da">
                                <datamodel>
                                    <VectorDouble key="baseToFeature" value="0,0,0,0,0,0"/>
                                    <Float64 key="blendRadius" value="0.02"/>
                                    <String key="blendType" value="NO_BLEND"/>
                                    ...
                                    <String key="type" value="POSITION"/>
                                    <String key="variableType" value="VARIABLE_POSE"/>
                                    <Waypoint key="waypoint" name="put2"/>
                                </datamodel>
                            </WaypointNode>
                        </children>
                    </MoveNode>
