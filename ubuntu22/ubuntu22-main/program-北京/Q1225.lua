--- Auto generated by 'aubo_scope' v0.31.0-alpha.58 2025-02-26 10:51:53
--- DO NOT MODIFY IT!
local app = {}
...
function p_Q1225()
    ...
    setLabel(22, "设置 control=811")
    modbusSetOutputSignal('control', 811)
    
    setLabel(23, "等待：1.50s")
    sleep(1.5)
    ...
    setLabel(26, "等待：5.00s")
    sleep(5)
    
    setLabel(27, "AGVgo1.lua")
    --subscript context start
    ...
    setLabel(34, "设置 control=1035")
    modbusSetOutputSignal('control', 1035)
    
    setLabel(35, "等待：1.50s")
    sleep(1.5)
    ...
    setLabel(43, "设置 finish=1")
    modbusSetOutputSignal('finish', 1)
    
    setLabel(44, "等待：1.00s")
    sleep(1)
    
    sched.sync_program_point()
    if (currentPointA==1.02256) then
        setLabel(45, "如果 currentPointA==1.02256")
        setLabel(46, "关节运动")
        setLabel(47, "UUUPPP")
        ...
        setLabel(63, "设置 control=1035")
        modbusSetOutputSignal('control', 1035)
        
        setLabel(64, "等待：1.50s")
        sleep(1.5)
        ...
        setLabel(70, "等待：1.00s")
        sleep(1)
        
        setLabel(71, "homeB")
        moveJoint(inverseKinematics(homeB_q, homeB_p), 0.872665, 0.698132, 0, 0)
        
        setLabel(72, "等待：1.00s")
        sleep(1)
        ...
        setLabel(75, "设置 control=811")
        modbusSetOutputSignal('control', 811)
        
        setLabel(76, "等待：1.50s")
        sleep(1.5)
