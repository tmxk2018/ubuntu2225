--- Auto generated by 'aubo_scope' v0.31.0-alpha.58 2024-10-29 17:52:26
--- DO NOT MODIFY IT!
local app = {}
...
function p_QQ1029()
    ...
    GetUpDeg = 0
    currentPointA = 0
    currentJointDeg = {-104.081, 0.525572, -63.9005, 25.5679, -89.9958, -49.8824}
    msg_AGV_G011 = 0
    setLabel(1, "初始变量")
    u57fau5ea7 = {0,0,0,0,0,0}
    u5de5u5177 = {0,0,0,0,0,0}
    homeB_p = {-0.441967433596898,-0.02941804362979441,0.415376361412519,-3.133189219099489,-0.009838559121930735,-0.9160318726821314}    
    homeB_q = {-0.2113918813170514,-0.1252620055392032,-1.738913540867836,-0.02991643667415276,-1.570825671019197,-0.8661974850083158}    
    pzdA_p = {-0.009485203625646903,0.4615944718873812,0.5982987473751148,3.14148281295803,3.358430735402149e-05,-2.516755929116341}    
    pzdA_q = {-1.816562390165835,0.00917298026484779,-1.115285599524292,0.4462412869626535,-1.570733970318258,-0.870602786681398}    
    ...
    while true do
        ...
        --subscript context start
         ip = "192.168.192.111" --服务端IP地址
            port = 55000 --串口号
            client_name = "sockfnbbgffeD1j" --客户端名称
