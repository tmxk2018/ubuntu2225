--- Auto generated by 'aubo_scope' v0.28.4-rc.18 2025-02-11 11:17:32
--- DO NOT MODIFY IT!
local app = {}
...
function p_u5f00()
    ...
    u8defu70b9_4_p = {-0.4735156736949812,-0.4181743122317584,0.4022114253021368,-0.4099499050375361,0.2006922666991275,2.460119292044102}    
    u8defu70b9_4_q = {-2.055090093232797,-0.1051166663202216,2.320735728413385,0.4815761397483395,-1.307407944155403,-0.1094111375072528}    
    ...
    setPlanContext(sched.current_thread_id(), 3, "function waitForMotionComplete()sleep(0) end")
    --subscript context start
    function waitForMotionComplete()sleep(0) end
    ...
    setPlanContext(sched.current_thread_id(), 6, "Seeragv  Move To: LM1 forward")
    ...
    setPlanContext(sched.current_thread_id(), 7, "Seeragv  Move To: LM2 forward")
    function waitForMotionComplete()
      sleep(0)
    end
    waitForMotionComplete()
    ...
    setPlanContext(sched.current_thread_id(), 11, "路点_2")
    ...
    setPlanContext(sched.current_thread_id(), 15, "路点_4")
    moveLine(u8defu70b9_4_p, 1.2, 0.25, 0, 0)
    
    setPlanContext(sched.current_thread_id(), 16, "直线运动")
    setPlanContext(sched.current_thread_id(), 17, "路点_5")
    ...
    setPlanContext(sched.current_thread_id(), 20, "Seeragv  Move To: LM3 forward")
    function waitForMotionComplete()
      sleep(0)
    end
    waitForMotionComplete()
    ...
    setPlanContext(sched.current_thread_id(), 22, "路点_7")
    moveLine(u8defu70b9_7_p, 1.2, 0.25, 0, 0)
    
    setPlanContext(sched.current_thread_id(), 23, "直线运动")
    setPlanContext(sched.current_thread_id(), 24, "路点_8")
    moveLine(u8defu70b9_8_p, 1.2, 0.25, 0, 0)
    
    setPlanContext(sched.current_thread_id(), 25, "直线运动")
    setPlanContext(sched.current_thread_id(), 26, "路点_9")
    moveLine(u8defu70b9_9_p, 1.2, 0.25, 0, 0)
    
    setPlanContext(sched.current_thread_id(), 27, "直线运动")
    setPlanContext(sched.current_thread_id(), 28, "路点_10")
    ...
    setPlanContext(sched.current_thread_id(), 31, "关节运动")
    setPlanContext(sched.current_thread_id(), 32, "路点_16")
    ...
    setPlanContext(sched.current_thread_id(), 34, "路点_12")
    moveLine(u8defu70b9_12_p, 1.2, 0.25, 0, 0)
    
    setPlanContext(sched.current_thread_id(), 35, "直线运动")
    setPlanContext(sched.current_thread_id(), 36, "路点_13")
    moveLine(u8defu70b9_13_p, 1.2, 0.25, 0, 0)
    
    setPlanContext(sched.current_thread_id(), 37, "直线运动")
    setPlanContext(sched.current_thread_id(), 38, "路点_20")
    moveLine(u8defu70b9_20_p, 1.2, 0.25, 0, 0)
    
    setPlanContext(sched.current_thread_id(), 39, "直线运动")
    setPlanContext(sched.current_thread_id(), 40, "路点_15")
    moveLine(u8defu70b9_15_p, 1.2, 0.25, 0, 0)
    
    setPlanContext(sched.current_thread_id(), 41, "直线运动")
    setPlanContext(sched.current_thread_id(), 42, "路点_17")
    moveLine(u8defu70b9_17_p, 1.2, 0.25, 0, 0)
    
    setPlanContext(sched.current_thread_id(), 43, "直线运动")
    setPlanContext(sched.current_thread_id(), 44, "路点_18")
    moveLine(u8defu70b9_18_p, 1.2, 0.25, 0, 0)
    
    setPlanContext(sched.current_thread_id(), 45, "关节运动")
    setPlanContext(sched.current_thread_id(), 46, "路点_19")
    moveJoint(inverseKinematics(u8defu70b9_19_q, u8defu70b9_19_p), 1.39626, 1.0472, 0, 0)
    
    setPlanContext(sched.current_thread_id(), 47, "Seeragv  Move To: LM4 forward")
    function waitForMotionComplete()
      sleep(0)
    end
    waitForMotionComplete()
    ...
    setPlanContext(sched.current_thread_id(), 48, "关节运动")
    setPlanContext(sched.current_thread_id(), 49, "路点_22")
